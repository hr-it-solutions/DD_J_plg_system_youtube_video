...
Adapted from [DD_J_plg_content_youtube_video](https://github.com/hr-it-solutions/DD_J_plg_content_youtube_video)
*NOTE: * Content Plg ist always to be preferred if it is sufficient!

YouTube provides free video-hosting, this plugin allows to simple embed YouTube videos everywhere, in the extended privacy mode.
